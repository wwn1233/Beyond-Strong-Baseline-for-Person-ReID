...
## Copyright (c) 2019
## Reference:
##     Weinong Wang et al. Orthogonal Center Learning with Subspace Masking for Person Re-Identification. summited in ICCV2019
##+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
# Proposal area need to be greater than RPN_MIN_AREA
# (at orig image scale; not scale used during training or inference)
__C.TRAIN.RPN_MIN_AREA = -1
...
# balance sample
__C.TRAIN.BALANCE_SAMPLE = False

##added by weinog  for only testing some cases, False for default 
__C.TRAIN.ON_EXPE = False
...
# [Infred Value] Scale for RPN_POST_NMS_TOP_N.
...
# added by Weinong Wang
__C.MRCNN.DICE_FOCAL = False
__C.MRCNN.DICE_WEIGZHT = 1.0
__C.MRCNN.FOCAL_WEIGZHT = 10.0
__C.MRCNN.FOCAL_GAMMA = 2.0
__C.MRCNN.BCE_WEIGZHT = 0.0
# ---------------------------------------------------------------------------- #
...
__C.KRCNN.ONLY_TRAIN_KEYPOINT = False
__C.KRCNN.TRAIN_EXPAND_ROI = -1.0
__C.KRCNN.HEAD_BN = False

# added by Weinong Wang
__C.KRCNN.LOSS = 'default' # 'default'(cross entropy), 'MSE', 'BCE', 'logestic', 'SoftmaxCrossentropyLoss'
__C.KRCNN.LABELINIT = False
__C.KRCNN.LABELINITMETHOD = 'gaussian' # gaussian

# added by weinong wang
__C.KRCNN.TONPY = False
...
# be fixed. 0 means not fixed any layer( including bn ,conv and so on)    *************************************Weinong
...
#added by Weinong Wang
__C.RESNETS.MODE_TORCHVISION = False


__C.RESNETS.DROPBLOCK = False # add dropblock in Resnet backbone
__C.RESNETS.DB_DROPPROB = 0.1
__C.RESNETS.DB_BLOCKSIZE = 5
__C.RESNETS.DB_LINEARSTEP = 5000

__C.RESNETS.SSN = False
# ---------------------------------------------------------------------------- #
# GroupNorm options
# ---------------------------------------------------------------------------- #
...
__C.REID = AttrDict()
__C.REID.DETECTRON_OPTIMIZER= True
__C.REID.BN_COMPLETE= True
__C.REID.PRE_PRO_TYPE = 0
__C.REID.HEIGHT = 256
__C.REID.WIDTH = 128
__C.REID.TRAIN_BATCH = 64
__C.REID.TEST_BATCH = 128
# Triplet
__C.REID.TRI_MARGIN = 0.3
__C.REID.TRI_NUM_INSTANCES = 4

__C.REID.HTRI_ONLY = False
__C.REID.LABLESMOOTH = False
__C.REID.RE_RANKING = False
__C.REID.TEST_DISTANCE = 'global'

__C.REID.ALIGNED = False
__C.REID.ALIGNED_TYPE = 'max'  # 'avg'
__C.REID.ALIGNED_PART = 8  # 'avg'

__C.REID.STRONG_BASELINE = True
__C.REID.FPN = False
__C.REID.FPN_TYPE = 0
__C.REID.LOSS = 'softmax+metric' # 'softmax' or 'metric'
__C.REID.ALIGNED_FPN = False
__C.REID.RE = False # random erase
__C.REID.FOCALLOSS = False

__C.REID.CENTER = 0.0 ##
__C.REID.SUBSPACE_MASKING = 'bernuli_sample' # bernuli_sample; eucli_important_sample; ohem_sample

__C.REID.REGULARIZED_POOLING = False ##

__C.REID.OIM_LABLESMOOTH = False
__C.REID.OIM_LABLESMOOTH_WARMUP = 0 # 18

__C.REID.ZERO_GAMMA = False
__C.REID.CLASSIFIER_NOBIAS = False # if true, the last fc has no bias

__C.REID.TEST_CASE =-1

__C.REID.WEIGHT_TEST = False
__C.REID.CAMIDCLASS = False

__C.REID.SWA = False
__C.REID.SWA_START = 360
__C.REID.SWA_FREQ = 5
__C.REID.SWA_LR = 0.000001

## applied OCSM to labelsmooth oim
__C.REID.OIM_OCSM = False
